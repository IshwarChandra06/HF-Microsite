...
import com.eikona.tech.util.ExportEventReport;
...
public class TransactionController {
	...
	@PreAuthorize("hasAuthority('transaction_view')")
	public void exportToFile(HttpServletResponse response,String sDate,String eDate, String employeeId, String employeeName, String device, String department, String designation, Principal principal) {
		...
		try {
			exportEventReport.fileExportBySearchValue(response,sDate, eDate, employeeId, employeeName,device,department, designation,orgName);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
